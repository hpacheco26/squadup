    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '20px', lineHeight: '1.7', color: '#334155', fontSize: '0.92rem' }}>
                ...
                <Section title={t('ppWhatWeCollectTitle')}>
                    {t('ppWhatWeCollectBody')}
                </Section>

                <Section title={t('ppHowWeUseTitle')}>
                    {t('ppHowWeUseBody')}
                </Section>

                <Section title={t('ppDataStorageTitle')}>
                    {t('ppDataStorageBody')}
                </Section>

                <Section title={t('ppThirdPartyTitle')}>
                    {t('ppThirdPartyBody')}
                </Section>

                <Section title={t('ppYourRightsTitle')}>
                    {t('ppYourRightsBody')}
                </Section>

                <Section title={t('ppContactTitle')}>
                    {t('ppContactBody')}
                </Section>
            </div>
        </div>
